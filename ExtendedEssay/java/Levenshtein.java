...
public class Levenshtein {
    public static void Calculate(String Original, String Search, SearchTree Tree) {
        ...
        int Distance = Matrix[OperatingOriginalString.length() - 1][Search.length() - 1];

        int TotalLen = (OperatingOriginalString.length() - 1) + (Search.length() - 1);
        ...
        Tree.Insert(new SearchTree(
                new LevenshteinData(Original, Score)
        ));
    }
}
